...
<!--img src="/legacy/xalgo.png" alt="Xalgorithms" style="display:block; margin: 30px auto;  width: 600px; border-radius:0;"/-->
...
A version of SBT _is_ available in the Fedora package manager, but we are going to use the official SBT repositories to download and install the latest stable SBT.
...
<!--![Image.](/legacy/opinion.gif){: .center-image}-->
